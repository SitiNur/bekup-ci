...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('task/ajax_list')?>",
            "type": "POST"
        },
...
function add_task()
{
    ...
    $('.modal-title').text('Add Task'); // Set Title to Bootstrap modal title
}
...
function edit_task(id_task)
{
    ...
    $.ajax({
        url : "<?php echo site_url('task/ajax_edit/')?>/"+id_task,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('task/ajax_add')?>";
    } else {
        url = "<?php echo site_url('task/ajax_update')?>";
    }
    console.log(url);
...
function delete_task(id_task)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('task/ajax_delete')?>/"+id_task,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Task Form</h3>
            </div>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="task" placeholder="task" class="form-control" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="time"  class="form-control timepicker1" type="time">
                                <span class="help-block"></span>
                            </div>
                        </div>
                   </div>
